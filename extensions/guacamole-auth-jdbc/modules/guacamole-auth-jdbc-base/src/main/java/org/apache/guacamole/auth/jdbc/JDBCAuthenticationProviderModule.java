...
import org.apache.guacamole.auth.jdbc.permission.WatchSessionPermissionSet;
...
import org.apache.guacamole.auth.jdbc.watchsession.ModeledWatchSession;
...
import org.apache.guacamole.auth.jdbc.watchsession.WatchSessionService;
...
public class JDBCAuthenticationProviderModule extends MyBatisModule {
    ...
    protected void initialize() {
        ...
        bind(ModeledWatchSession.class);
        ...
        bind(WatchSessionDirectory.class);
        bind(WatchSessionPermissionSet.class);
        ...
        bind(WatchSessionPermissionService.class);
        bind(WatchSessionService.class);
