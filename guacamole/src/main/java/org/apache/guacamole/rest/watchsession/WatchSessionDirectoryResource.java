...
public class WatchSessionDirectoryResource
        extends DirectoryResource<WatchSession, APIWatchSession> {

    /**
     * Creates a new WatchSessionDirectoryResource which exposes the
     * operations and subresources available for the given WatchSession
     * Directory.
     *
     ...
     *     representing WatchSessions.
     */
    @AssistedInject
    public WatchSessionDirectoryResource(
            ...
            DirectoryObjectResourceFactory<WatchSession, APIWatchSession> resourceFactory) {
        super(authenticatedUser, userContext, WatchSession.class, directory, translator, resourceFactory);
    }

    @Override
    protected ObjectPermissionSet getObjectPermissions(Permissions permissions)
            throws GuacamoleException {
        return permissions.getWatchSessionPermissions();
    }
